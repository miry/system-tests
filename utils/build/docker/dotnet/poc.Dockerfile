...
COPY utils/build/docker/dotnet/aspnetcore/app.csproj app.csproj

COPY utils/build/docker/dotnet/aspnetcore/*.cs ./
COPY utils/build/docker/dotnet/aspnetcore/Dependencies/*.cs ./Dependencies/
COPY utils/build/docker/dotnet/aspnetcore/Endpoints/*.cs ./Endpoints/
COPY utils/build/docker/dotnet/aspnetcore/Controllers/*.cs ./Controllers/
COPY utils/build/docker/dotnet/aspnetcore/Models/*.cs ./Models/
COPY utils/build/docker/dotnet/aspnetcore/Models/*/*.cs ./Models/
COPY utils/build/docker/dotnet/aspnetcore/IdentityStores/*.cs ./IdentityStores/
...
COPY utils/build/docker/dotnet/aspnetcore/app.sh app.sh
